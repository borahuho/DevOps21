...
Vagrant.configure('2') do |config|
    ...
    config.vm.define "manager", primary: true do |machine1|
        ...
        machine1.vm.network "private_network", ip: "192.168.10.190"
    ...
    config.vm.define "worker1", primary: false do |machine2|
        ...
        machine2.vm.network "private_network", ip: "192.168.10.191"
        ...
        machine3.vm.network "private_network", ip: "192.168.10.192"
